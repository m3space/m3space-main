...
namespace GroundControl.Core
{
    ...
    public class DataFormat
    {
        ...
        public static string TelemetryDisplayString(TelemetryData data)
        {
            ...
            return String.Format("[Telemetry] {0:dd.MM.yyyy HH:mm:ss} Loc:{1}°{2:0.###}'{3} {4}°{5:0.###}'{6} Alt:{7:0.#}m PAlt:{8:0.#}m Head:{9:0.#}° HSpd:{10:0.#}m/s VSpd:{11:0.#}m/s Sat:{12} TInt:{13}°C T1:{14:0.#}°C T2:{15:0.#}°C P:{16:0.####}bar Vin:{17:0.##}V Duty:{18}%",
